...
from .views import UserViewSet, AuditLogViewSet, SignupView, CurrentUserView, ChangePasswordView, Setup2FAView, Verify2FAView, Disable2FAView, LoginActivityListAPIView, Verify2FALoginView, CustomTokenObtainPairView
...
urlpatterns = [
    ...
    path('api/token/tenant/', CustomTokenObtainPairView.as_view(), name='tenant_token_obtain_pair'),
